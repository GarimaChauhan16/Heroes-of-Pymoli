...
The objective of this project is to analyze the data for a hypothetical fantasy game called "Heroes of Pymoli".
...
The task here is to analyze the district-wide standardized test results and then to aggregate the data to and showcase obvious trends in school performance.
